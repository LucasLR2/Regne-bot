...
class Invites(commands.Cog):
    ...
    async def inv_base(self, ctx):
        ...
        embed = discord.Embed(
            ...
            description="¡El sistema está funcionando! Usa `invhelp` para ver todos los comandos.",
            color=0x00ff88
        )
        embed.add_field(
            name="📋 Comando de ayuda",
            value="`invhelp` - Ver todos los comandos",
            inline=False
        )
        embed.add_field(
            name="🧪 Comando de test",
            value="`invtest` - Probar el sistema",
            inline=False
        )
        await ctx.send(embed=embed)
    
    @commands.command(name="invdebug")
    @commands.has_permissions(manage_guild=True)
    async def inv_debug(self, ctx):
    ...
    @commands.command(name="invrefresh", aliases=["inv_refresh"])
    @commands.has_permissions(manage_guild=True)
    ...
    @commands.command(name="invmanual")
    @commands.has_permissions(manage_guild=True)
    ...
    @commands.command(name="invtest", aliases=["invites_test", "test_invites", "testinv"])
    async def invites_test(self, ctx):
        ...
        try:
            ...
            embed.add_field(
                ...
                value="`invhelp` para ver todos los comandos",
                inline=True
            )
    ...
    @commands.command(name="invhelp", aliases=["inv_help", "invites_help", "help_invites", "ayuda_invites"])
    async def invites_help(self, ctx):
        ...
        embed.add_field(
            ...
            value=(
                "`invinvitaciones [usuario]` - Ver invitaciones de un usuario\n"
                "`invquienmeinvito [usuario]` - Ver quién invitó a alguien\n"
                "`invleaderboard [límite]` - Top de invitadores\n"
                "`mirango` - Tu posición en el ranking"
            ),
            inline=False
        )
        ...
        if ctx.author.guild_permissions.manage_guild:
            embed.add_field(
                ...
                value=(
                    "`invinfo` - Estadísticas del sistema\n"
                    "`invdebug` - Debug del sistema\n"
                    "`invrefresh` - Refrescar cache\n"
                    "`invmanual [usuario] [invitador]` - Registrar manualmente"
                ),
                inline=False
            )
        ...
        embed.add_field(
            ...
            value=(
                "`invtest` - Test del sistema\n"
                "`invhelp` - Mostrar esta ayuda"
            ),
            inline=False
        )
        ...
        embed.add_field(
            ...
            value=(
                "`invites` = `invinvitaciones`\n"
                "`whoinvited` = `invquienmeinvito`\n"
                "`invlb` = `invleaderboard` = `topinv`\n"
                "`invhelp` = `ayuda_invites`\n"
                "`invtest` = `test_invites`"
            ),
            inline=False
        )
    ...
    @commands.command(name="invinvitaciones", aliases=["invites", "invitaciones"])
    async def invitaciones(self, ctx, member: discord.Member = None):
    ...
    @commands.command(name="invquienmeinvito", aliases=["quienmeinvito", "whoinvited", "invwho"])
    async def quien_me_invito(self, ctx, member: discord.Member = None):
    ...
    @commands.command(name="invleaderboard", aliases=["invlb", "inv_top", "topinv"])
    ...
    @commands.command(name="mirango", aliases=["mi_rango", "myrank", "mirank"])
    async def mi_rango(self, ctx):
    ...
    @commands.command(name="invinfo", aliases=["invites_info", "info_invites"])
    @commands.has_permissions(manage_guild=True)
